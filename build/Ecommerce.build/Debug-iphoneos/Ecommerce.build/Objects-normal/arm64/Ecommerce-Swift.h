...
#ifndef ECOMMERCE_SWIFT_H
#define ECOMMERCE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Ecommerce",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSString;
@class NSDate;
@interface Address (SWIFT_EXTENSION(Ecommerce))
...
@interface Cart (SWIFT_EXTENSION(Ecommerce))
@property (nonatomic, copy) NSString * _Nonnull id;
@property (nonatomic, copy) NSString * _Nonnull userId;
...
@interface Order (SWIFT_EXTENSION(Ecommerce))
@property (nonatomic, copy) NSString * _Nonnull id;
@property (nonatomic, copy) NSString * _Nonnull userId;
@property (nonatomic, copy) NSString * _Nullable orderNumber;
@property (nonatomic, strong) NSDecimalNumber * _Nonnull totalAmount;
@property (nonatomic, strong) NSDecimalNumber * _Nullable subtotal;
@property (nonatomic, strong) NSDecimalNumber * _Nullable taxAmount;
...
@property (nonatomic, copy) NSString * _Nullable paymentStatus;
...
@interface OrderItem (SWIFT_EXTENSION(Ecommerce))
@property (nonatomic, copy) NSString * _Nonnull id;
@property (nonatomic, copy) NSString * _Nonnull orderId;
@property (nonatomic, copy) NSString * _Nonnull productId;
@property (nonatomic) int32_t quantity;
@property (nonatomic, strong) NSDecimalNumber * _Nonnull price;
...
@interface Product (SWIFT_EXTENSION(Ecommerce))
@property (nonatomic, copy) NSString * _Nonnull id;
...
@property (nonatomic) int32_t stockQuantity;
@property (nonatomic) double rating;
@property (nonatomic) BOOL isFeatured;
@property (nonatomic) BOOL isOnSale;
@property (nonatomic, strong) NSDecimalNumber * _Nullable salePrice;
@property (nonatomic, copy) NSDate * _Nullable createdAt;
@property (nonatomic, copy) NSDate * _Nullable updatedAt;
...
@interface User (SWIFT_EXTENSION(Ecommerce))
@property (nonatomic, copy) NSString * _Nonnull id;
@property (nonatomic, copy) NSString * _Nullable name;
